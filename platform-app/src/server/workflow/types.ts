...
export const NODE_REGISTRY: Record<WorkflowNodeType, NodeDefinition> = {
    ...
    mask: {
        ...
        description: "Линейный альфа-градиент с задаваемой областью действия (как Layer Mask в Figma).",
        category: "transform",
    ...
    blur: {
        type: "blur",
        displayName: "Блюр",
        description: "Uniform или Progressive блюр (как Layer Blur в Figma) с задаваемой областью и направлением.",
        category: "transform",
        inputs: [{ id: "image-in", type: "image", label: "Изображение", required: true }],
        outputs: [{ id: "image-out", type: "image", label: "Изображение" }],
        defaultParams: {
