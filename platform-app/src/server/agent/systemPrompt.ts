...
0. РЕФЕРЕНСНЫЕ ФОТО: Если в визуальном контексте описаны загруженные пользователем фото товаров/объектов:
   - НЕ ищи шаблоны. Сразу генерируй контент.
   - Используй ТОЧНЫЕ описания объектов из визуального контекста в промптах для generate_image
   ...
   Пример плана для "объедини товары":
   a) generate_image — промпт должен содержать описание КАЖДОГО товара из визуального контекста
