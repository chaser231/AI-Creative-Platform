    ...
    addRectangleLayer: (overrides = {}) => {
        ...
        const { layer: finalLayer, master, instances } = createLayerWithMasterAndInstances(
            layer,
            {
                ...
                fill: layer.fill, fillMode: layer.fillMode, imageFill: layer.imageFill,
                fillEnabled: layer.fillEnabled,
                stroke: layer.stroke, strokeMode: layer.strokeMode, strokeImage: layer.strokeImage,
                strokeEnabled: layer.strokeEnabled,
                strokeWidth: layer.strokeWidth, strokeAlign: layer.strokeAlign,
                strokeJoin: layer.strokeJoin,
                cornerRadius: layer.cornerRadius, cornerRadii: layer.cornerRadii,
            },
    ...
    addImageLayer: (src, width, height) => {
        ...
        const { layer: finalLayer, master, instances } = createLayerWithMasterAndInstances(
            layer,
            {
                ...
                fill: layer.fill, fillMode: layer.fillMode, fillEnabled: layer.fillEnabled,
                stroke: layer.stroke, strokeMode: layer.strokeMode, strokeImage: layer.strokeImage,
                strokeEnabled: layer.strokeEnabled,
                strokeWidth: layer.strokeWidth, strokeAlign: layer.strokeAlign,
                strokeJoin: layer.strokeJoin, cornerRadius: layer.cornerRadius, cornerRadii: layer.cornerRadii,
            },
    ...
    wrapInAutoLayoutFrame: () => {
        ...
        const { layer: finalFrame, master, instances } = createLayerWithMasterAndInstances(
            frameLayer,
            {
                ...
                strokeMode: frameLayer.strokeMode, strokeImage: frameLayer.strokeImage,
