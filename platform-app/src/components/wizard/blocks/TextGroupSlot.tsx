            ...
            <div className="flex items-center justify-between px-4 py-2.5 border-b border-border-primary bg-bg-primary">
                ...
                <button
                    ...
                    className={`flex items-center gap-1.5 px-2 py-1 text-[11px] font-medium rounded-[var(--radius-sm)] border transition-all cursor-pointer ${
                        showGroupGen
                            ? "bg-accent-lime text-accent-lime-text border-accent-lime-hover"
                ...
                <div className="px-4 py-3 border-b border-border-primary bg-bg-secondary space-y-3">
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="h-9 px-4 rounded-[var(--radius-md)] bg-accent-lime text-accent-lime-text font-semibold text-xs hover:bg-accent-lime-hover disabled:opacity-50 transition-all cursor-pointer disabled:cursor-default shrink-0 flex items-center gap-1.5"
                        >
